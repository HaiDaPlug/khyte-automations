// ARCHIVED — original contact form layout
// Revert: copy contents of this file to page.tsx
        ...
        <main className="pt-32 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              >
                <div>
                  <label htmlFor="name" className="block text-label mb-2">Namn *</label>
                  <input
                ...
                <div>
                  <label htmlFor="company" className="block text-label mb-2">Företag</label>
                  <input
                ...
                <div>
                  <label htmlFor="phone" className="block text-label mb-2">Telefon</label>
                  <input
                ...
                <div>
                  <label htmlFor="email" className="block text-label mb-2">E-post *</label>
                  <input
                ...
                <div>
                  <label htmlFor="message" className="block text-label mb-2">Meddelande *</label>
                  <textarea
            ...
            <div className="bg-[var(--color-card-bg)] border border-[rgba(58,51,48,0.25)] [border-width:var(--border-width)] p-8 rounded-[4px] transition-colors duration-300 hover:border-[var(--color-muted)]">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div>
                  <p className="text-label mb-2">Telefon</p>
                  <a href="tel:070-099 68 38" className="text-xl text-[var(--color-text)] hover:text-[var(--color-accent)] transition-colors underline underline-offset-2">
                    070-099 68 38
                  </a>
                </div>

                <div>
                  <p className="text-label mb-3">Boka möte</p>
                  <CalendlyButton variant="primary">Boka 30 min</CalendlyButton>
                </div>
              </div>
