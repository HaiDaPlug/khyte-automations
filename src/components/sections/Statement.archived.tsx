    ...
    <section ref={sectionRef} className="mb-0">
      <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen">
        <div className="relative overflow-hidden isolate" style={{ background: "var(--color-bg)" }}>
          ...
          <div className="max-w-[1280px] mx-auto px-6 pt-2 pb-24 md:pt-4 md:pb-32">
            ...
            >
              <h2
                className="text-4xl md:text-5xl lg:text-6xl leading-[1.08] tracking-[-0.03em] mb-16 md:mb-20 text-center"
              ...
              >
                ...
                <span
                  className="block font-medium text-[var(--color-muted)] max-w-[32ch] text-balance mx-auto"
